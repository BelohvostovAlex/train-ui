...
var BookSliderItemWrapperHorizontal = styled.div(templateObject_1$8 || (templateObject_1$8 = tslib.__makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: start;\n  margin: 10px auto;\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: start;\n  margin: 10px auto;\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"])), BookSliderItemWrapperWidth, BookSliderItemWrapperHeight, function (_a) {
    var theme = _a.theme;
...
var BookSliderItemSquare = styled.div(templateObject_2$4 || (templateObject_2$4 = tslib.__makeTemplateObject(["\n  height: ", ";\n  width: ", ";\n  opacity: ", ";\n  border-radius: ", ";\n  background: ", ";\n  ", ";\n  justify-content: center;\n  flex-direction: column;\n  border: 1px solid ", ";\n  ", ";\n  font-size: ", ";\n  color: ", ";\n"], ["\n  height: ", ";\n  width: ", ";\n  opacity: ", ";\n  border-radius: ", ";\n  background: ", ";\n  ", ";\n  justify-content: center;\n  flex-direction: column;\n  border: 1px solid ", ";\n  ", ";\n  font-size: ", ";\n  color: ", ";\n"])), function (_a) {
...
var BookSliderItemMonth = styled.span(templateObject_3$4 || (templateObject_3$4 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n  color: ", ";\n"], ["\n  ", ";\n  font-size: ", ";\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.typography.nunito_l;
}, function (_a) {
    var theme = _a.theme;
...
var BookSliderItemWrapperVertical = styled.div(templateObject_4$3 || (templateObject_4$3 = tslib.__makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  margin: 10px auto;\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  margin: 10px auto;\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"])), BookSliderItemWrapperVerticalWidth, BookSliderItemWrapperVerticalHeight, function (_a) {
    var theme = _a.theme;
    return theme.border_radius[10];
}, function (_a) {
...
var BookSliderItem = function (_a) {
    ...
    return direction === SliderDirectionVariant.HORIZONTAL ? (React.createElement(BookSliderItemWrapperHorizontal, { center: center, left: left, right: right, prevLeft: prevLeft, prevRight: prevRight, direction: direction },
        React.createElement(BookSliderItemSquare, { center: center, left: left, right: right, prevLeft: prevLeft, prevRight: prevRight, direction: direction },
            item,
            React.createElement(BookSliderItemMonth, null, month)))) : (React.createElement(BookSliderItemWrapperVertical, { center: center, bot: bot, left: left, right: right, prevLeft: prevLeft, prevRight: prevRight, direction: direction, top: top },
        React.createElement(BookSliderItemSquare, { center: center, left: left, right: right, prevLeft: prevLeft, prevRight: prevRight, direction: direction },
            item,
            React.createElement(BookSliderItemMonth, null, month))));
};
...
var svgWidth = 16;
var StyledButton = styled.button(templateObject_1$7 || (templateObject_1$7 = tslib.__makeTemplateObject(["\n  ", "\n  font-size: ", ";\n  background: ", ";\n  color: ", ";\n  border-radius: ", ";\n  width: ", ";\n  height: ", ";\n  margin: ", ";\n  ", ";\n  justify-content: center;\n  position: relative;\n  border: none;\n  svg {\n    position: absolute;\n    top: 50%;\n    left: 10%;\n    transform: translate(-10%, -50%);\n    width: ", "px;\n    height: auto;\n  }\n  padding: 6px 36px;\n  cursor: pointer;\n  &:hover {\n    ", "\n  }\n  transition: linear 0.2s;\n"], ["\n  ", "\n  font-size: ", ";\n  background: ", ";\n  color: ", ";\n  border-radius: ", ";\n  width: ", ";\n  height: ", ";\n  margin: ", ";\n  ", ";\n  justify-content: center;\n  position: relative;\n  border: none;\n  svg {\n    position: absolute;\n    top: 50%;\n    left: 10%;\n    transform: translate(-10%, -50%);\n    width: ", "px;\n    height: auto;\n  }\n  padding: 6px 36px;\n  cursor: pointer;\n  &:hover {\n    ", "\n  }\n  transition: linear 0.2s;\n"])), function (_a) {
...
var Button = function (_a) {
    ...
    return (React.createElement(StyledButton, { variant: variant, buttonTypes: buttonTypes, onClick: onClick, height: height, width: width, typography: typography, fontSize: fontSize, backgroundColor: backgroundColor, color: color, margin: margin, icon: icon },
        icon,
        children));
};

var ChipWrapper = styled.div(templateObject_1$6 || (templateObject_1$6 = tslib.__makeTemplateObject(["\n  padding: 5px 6px;\n  border-radius: ", ";\n  background: ", ";\n  color: ", ";\n  ", ";\n  font-size: ", ";\n  width: fit-content;\n  margin: 5px;\n"], ["\n  padding: 5px 6px;\n  border-radius: ", ";\n  background: ", ";\n  color: ", ";\n  ", ";\n  font-size: ", ";\n  width: fit-content;\n  margin: 5px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.border_radius[10];
}, function (_a) {
...
var Chip = function (_a) {
    ...
    return React.createElement(ChipWrapper, { background: background }, text);
};
...
var DividerWrapper = styled.div(templateObject_1$5 || (templateObject_1$5 = tslib.__makeTemplateObject(["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n"], ["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n"])), function (_a) {
    var width = _a.width;
    return width;
}, function (_a) {
    var height = _a.height;
...
var Divider = function (_a) {
    ...
    return React.createElement(DividerWrapper, { color: color, height: height, width: width });
};

var FacebookSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "19", height: "20", viewBox: "0 0 19 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("path", { d: "M18.129 10.0611C18.129 4.50452 14.0852 0 9.09677 0C4.10839 0 0.0645142 4.50452 0.0645142 10.0611C0.0645142 15.0829 3.36748 19.2453 7.68548 20V12.9694H5.39214V10.0611H7.68548V7.84454C7.68548 5.32297 9.03394 3.93013 11.0971 3.93013C12.0853 3.93013 13.1189 4.12664 13.1189 4.12664V6.60262H11.98C10.858 6.60262 10.5081 7.37817 10.5081 8.17383V10.0611H13.0131L12.6126 12.9694H10.5081V20C14.8261 19.2453 18.129 15.0829 18.129 10.0611Z", fill: "white" }))); };
...
var FacebookButton = function (_a) {
    ...
    return (React.createElement(Button, { typography: typography, width: width, height: height, fontSize: fontSize, backgroundColor: backgroundColor, color: color, onClick: onClick, icon: React.createElement(FacebookSvg, null), buttonTypes: buttonTypes, margin: margin, variant: variant }, children));
};

var GithubSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "22", height: "24", viewBox: "0 0 22 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("path", { d: "M10.9032 2.2467C8.75849 2.2468 6.68377 3.09182 5.05029 4.63055C3.41681 6.16929 2.33116 8.30133 1.9876 10.6452C1.64404 12.989 2.06499 15.3918 3.17513 17.4235C4.28527 19.4551 6.01215 20.9832 8.04679 21.7342C8.4984 21.8217 8.66776 21.5217 8.66776 21.2592C8.66776 21.0217 8.65646 20.2342 8.65646 19.3967C6.38709 19.8592 5.8 18.7842 5.61935 18.2217C5.41891 17.6747 5.10115 17.1899 4.69355 16.8092C4.37742 16.6217 3.9258 16.1592 4.68225 16.1467C4.97109 16.1814 5.24812 16.2927 5.48986 16.4711C5.7316 16.6495 5.93093 16.8899 6.07097 17.1717C6.1945 17.4174 6.36061 17.6337 6.55978 17.8082C6.75895 17.9827 6.98727 18.112 7.23164 18.1886C7.47601 18.2652 7.73165 18.2877 7.98389 18.2548C8.23613 18.2219 8.48002 18.1342 8.70159 17.9967C8.74069 17.4883 8.94534 17.013 9.27742 16.6592C7.26774 16.4092 5.16774 15.5467 5.16774 11.7217C5.15505 10.7279 5.48629 9.76631 6.09355 9.03423C5.81741 8.17045 5.84972 7.22252 6.18387 6.38423C6.18387 6.38423 6.94029 6.12172 8.66774 7.40923C10.1457 6.95921 11.7059 6.95921 13.1839 7.40923C14.9113 6.10923 15.6677 6.38423 15.6677 6.38423C16.0019 7.22251 16.0342 8.17046 15.7581 9.03423C16.3671 9.76506 16.6987 10.7275 16.6839 11.7217C16.6839 15.5592 14.5726 16.4092 12.5629 16.6592C12.7785 16.9011 12.9445 17.1915 13.0497 17.5107C13.1549 17.83 13.1968 18.1705 13.1726 18.5092C13.1726 19.8468 13.1613 20.9217 13.1613 21.2592C13.1613 21.5217 13.3306 21.8342 13.7822 21.7342C15.8133 20.9771 17.5352 19.4455 18.6406 17.4128C19.746 15.38 20.163 12.9785 19.8171 10.6369C19.4711 8.29535 18.3848 6.16608 16.752 4.62922C15.1193 3.09235 13.0463 2.24794 10.9032 2.2467Z", fill: "white" }))); };

var GithubButton = function (_a) {
    var typography = _a.typography, backgroundColor = _a.backgroundColor, buttonTypes = _a.buttonTypes, children = _a.children, color = _a.color, fontSize = _a.fontSize, height = _a.height, margin = _a.margin, onClick = _a.onClick, variant = _a.variant, width = _a.width;
    return (React.createElement(Button, { typography: typography, width: width, height: height, fontSize: fontSize, backgroundColor: backgroundColor, color: color, onClick: onClick, icon: React.createElement(GithubSvg, null), buttonTypes: buttonTypes, margin: margin, variant: variant }, children));
};

var GoogleSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "16", height: "17", viewBox: "0 0 16 17", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("g", { clipPath: "url(#clip0_1_260)" },
        React__namespace.createElement("path", { d: "M15.4112 8.65904C15.4112 7.96256 15.3589 7.45431 15.2459 6.92725H7.8948V10.0708H12.2097C12.1228 10.852 11.653 12.0285 10.609 12.8191L10.5944 12.9244L12.9187 14.8724L13.0797 14.8898C14.5586 13.4121 15.4112 11.2379 15.4112 8.65904Z", fill: "#4285F4" }),
        React__namespace.createElement("path", { d: "M7.8948 16.9416C10.0087 16.9416 11.7834 16.1886 13.0797 14.8898L10.609 12.8191C9.94788 13.3179 9.06051 13.6662 7.8948 13.6662C5.82433 13.6662 4.06704 12.1885 3.44061 10.1461L3.3488 10.1546L0.931977 12.1781L0.900371 12.2732C2.18789 15.0403 4.83254 16.9416 7.8948 16.9416Z", fill: "#34A853" }),
        React__namespace.createElement("path", { d: "M3.44085 10.1461C3.27557 9.61904 3.17991 9.05428 3.17991 8.47076C3.17991 7.88718 3.27557 7.32248 3.43216 6.79542L3.42778 6.68317L0.980675 4.62708L0.90061 4.66828C0.369963 5.81656 0.0654764 7.10603 0.0654764 8.47076C0.0654764 9.8355 0.369963 11.1249 0.90061 12.2732L3.44085 10.1461Z", fill: "#FBBC05" }),
        React__namespace.createElement("path", { d: "M7.8948 3.27535C9.36499 3.27535 10.3567 3.96243 10.9222 4.5366L13.1319 2.20241C11.7748 0.837672 10.0087 0 7.8948 0C4.83254 0 2.18789 1.90121 0.900371 4.66832L3.43192 6.79546C4.06704 4.75306 5.82433 3.27535 7.8948 3.27535Z", fill: "#EB4335" })),
    React__namespace.createElement("defs", null,
        React__namespace.createElement("clipPath", { id: "clip0_1_260" },
            React__namespace.createElement("rect", { width: "15.3548", height: "17", fill: "white", transform: "translate(0.0644455)" }))))); };

var GoogleButton = function (_a) {
    var typography = _a.typography, backgroundColor = _a.backgroundColor, buttonTypes = _a.buttonTypes, children = _a.children, color = _a.color, fontSize = _a.fontSize, height = _a.height, margin = _a.margin, onClick = _a.onClick, variant = _a.variant, width = _a.width;
    return (React.createElement(Button, { typography: typography, width: width, height: height, fontSize: fontSize, backgroundColor: backgroundColor, color: color, onClick: onClick, icon: React.createElement(GoogleSvg, null), buttonTypes: buttonTypes, margin: margin, variant: variant }, children));
};

var SeatSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ xmlns: "http://www.w3.org/2000/svg", version: "1.1", id: "mdi-car-seat", width: "24", height: "24", viewBox: "0 0 24 24" }, props),
    React__namespace.createElement("path", { d: "M7 18C7 18 4 10 4 6S6 2 6 2H7C7 2 8 2 8 3S7 4 7 6 10 10 10 13 7 18 7 18M12 17C11 17 8 19.5 8 19.5C7.7 19.7 7.8 20 8 20.3C8 20.3 9 22.1 11 22.1H17C18.1 22.1 19 21.2 19 20.1V19.1C19 18 18.1 17.1 17 17.1H12Z" }))); };
...
var MovieHallBadgeWrapper = styled.div(templateObject_1$4 || (templateObject_1$4 = tslib.__makeTemplateObject(["\n  width: ", "%;\n  max-width: fit-content;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n  color: ", ";\n  padding: 10px;\n\n  @media (max-width: ", ") {\n    width: ", "%;\n    max-width: ", "%;\n    margin-bottom: 10px;\n  }\n"], ["\n  width: ", "%;\n  max-width: fit-content;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n  color: ", ";\n  padding: 10px;\n\n  @media (max-width: ", ") {\n    width: ", "%;\n    max-width: ", "%;\n    margin-bottom: 10px;\n  }\n"])), MovieHallBadgeWrapperWidthPercent, function (_a) {
    var theme = _a.theme;
...
var MovieHallBadgeTime = styled.h3(templateObject_2$3 || (templateObject_2$3 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n"], ["\n  ", ";\n  font-size: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var MovieHallBadgeNumber = styled.h4(templateObject_3$3 || (templateObject_3$3 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n"], ["\n  ", ";\n  font-size: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var MovieHallBadgeSeats = styled.p(templateObject_4$2 || (templateObject_4$2 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n  ", ";\n  svg {\n    margin-right: 5px;\n    height: ", "px;\n    width: auto;\n  }\n  svg path {\n    fill: ", ";\n  }\n"], ["\n  ", ";\n  font-size: ", ";\n  ", ";\n  svg {\n    margin-right: 5px;\n    height: ", "px;\n    width: auto;\n  }\n  svg path {\n    fill: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var MovieHallBadge = function (_a) {
    ...
    return (React.createElement(MovieHallBadgeWrapper, { isActive: isActive, onClick: onClick },
        React.createElement(MovieHallBadgeTime, null, time),
        React.createElement(MovieHallBadgeNumber, null,
            movieBadgeHallTitle,
            ": ",
            hallNumber),
        React.createElement(MovieHallBadgeSeats, null,
            React.createElement(SeatSvg, null),
            available,
            " ",
            availableSeatsText)));
};
...
var MovieSliderItemWrapperVertical = styled.div(templateObject_1$3 || (templateObject_1$3 = tslib.__makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  margin: 10px auto;\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  margin: 10px auto;\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"])), MovieSliderItemWrapperWidth, MovieSliderItemWrapperHeight, function (_a) {
    var theme = _a.theme;
    return theme.border_radius[10];
}, function (_a) {
    var top = _a.top, center = _a.center, bot = _a.bot;
...
var MovieSliderImgVertical = styled.img(templateObject_2$2 || (templateObject_2$2 = tslib.__makeTemplateObject(["\n  width: ", "%;\n  height: ", "%;\n  border-radius: ", ";\n"], ["\n  width: ", "%;\n  height: ", "%;\n  border-radius: ", ";\n"])), MovieSliderImgVerticalWidthPercent, MovieSliderImgVerticalHeightPercent, function (_a) {
    var theme = _a.theme;
    return theme.border_radius[10];
});
var MovieSliderImgHorizontal = styled.img(templateObject_3$2 || (templateObject_3$2 = tslib.__makeTemplateObject(["\n  height: ", ";\n  width: ", ";\n  border-radius: ", ";\n"], ["\n  height: ", ";\n  width: ", ";\n  border-radius: ", ";\n"])), function (_a) {
    var prevLeft = _a.prevLeft, prevRight = _a.prevRight, left = _a.left, right = _a.right;
    return prevRight || prevLeft
...
var MovieSliderItemWrapperHorizontal = styled.div(templateObject_4$1 || (templateObject_4$1 = tslib.__makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: start;\n  margin: 10px auto;\n  width: 490px;\n  height: 200px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: flex;\n  align-items: start;\n  margin: 10px auto;\n  width: 490px;\n  height: 200px;\n  border-radius: ", ";\n  transform: ", ";\n  transition: 0.2s ease-out;\n  cursor: pointer;\n  zindex: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.border_radius[10];
}, function (_a) {
    var left = _a.left, center = _a.center, right = _a.right, prevLeft = _a.prevLeft, prevRight = _a.prevRight;
...
var MovieSliderItem = function (_a) {
    ...
    return direction === SliderDirectionVariant.HORIZONTAL ? (React.createElement(MovieSliderItemWrapperHorizontal, { center: center, top: top, bot: bot, left: left, prevLeft: prevLeft, prevRight: prevRight, right: right, onClick: handleId },
        React.createElement(MovieSliderImgHorizontal, { src: src, center: center, prevLeft: prevLeft, prevRight: prevRight, left: left, right: right }))) : (React.createElement(MovieSliderItemWrapperVertical, { center: center, top: top, bot: bot, left: left, prevLeft: prevLeft, prevRight: prevRight, right: right, onClick: handleId },
        React.createElement(MovieSliderImgVertical, { src: src })));
};

var ArrowDownSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "16", height: "20", viewBox: "0 0 16 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("path", { d: "M7.32204 19.7029C7.71041 20.0956 8.34356 20.0991 8.73623 19.7107L15.1352 13.382C15.5279 12.9936 15.5314 12.3604 15.143 11.9678C14.7546 11.5751 14.1215 11.5716 13.7288 11.96L8.04084 17.5855L2.41527 11.8976C2.02691 11.5049 1.39375 11.5014 1.00108 11.8898C0.608409 12.2781 0.604916 12.9113 0.993281 13.304L7.32204 19.7029ZM7.13234 0.994484L7.03305 18.9942L9.03302 19.0052L9.13231 1.00552L7.13234 0.994484Z", fill: "black" }))); };

var ArrowUpSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "20px", height: "18px", viewBox: "0 0 20 18", version: "1.1", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("title", null, "ic_upward"),
    React__namespace.createElement("desc", null, "Created with Sketch."),
    React__namespace.createElement("defs", null),
    React__namespace.createElement("g", { id: "Icons", stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" },
        React__namespace.createElement("g", { id: "24-px-Icons", transform: "translate(-266.000000, -27.000000)", stroke: "#000000" },
            React__namespace.createElement("g", { id: "ic_upward", transform: "translate(264.000000, 24.000000)" },
                React__namespace.createElement("g", { transform: "translate(12.000000, 12.000000) rotate(-270.000000) translate(-12.000000, -12.000000) ", id: "ic_back" },
                    React__namespace.createElement("g", { transform: "translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) ", strokeWidth: "2" },
                        React__namespace.createElement("g", { id: "forward", transform: "translate(4.000000, 3.000000)" },
                            React__namespace.createElement("path", { d: "M0,9 L16,9", id: "Line" }),
                            React__namespace.createElement("path", { d: "M16,9 L7.93774223,0.937742233", id: "Line" }),
                            React__namespace.createElement("path", { d: "M16,9 L7.93774223,17.0622578", id: "Line" }))))))))); };

var styledRoundButtonSVGWidthPercent = 50;
var styledRoundButtonSVGHeightPercent = 50;
var StyledRoundButton = styled.div(templateObject_1$2 || (templateObject_1$2 = tslib.__makeTemplateObject(["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n  border-radius: ", ";\n  padding: 5px;\n  ", ";\n  justify-content: center;\n  &:hover {\n    ", "\n  }\n  svg {\n    width: ", "%;\n    height: ", ";\n  }\n  svg line {\n    stroke: ", ";\n  }\n\n  svg path {\n    fill: ", ";\n  }\n  cursor: pointer;\n  color: ", ";\n  ", ";\n"], ["\n  width: ", ";\n  height: ", ";\n  background: ", ";\n  border-radius: ", ";\n  padding: 5px;\n  ", ";\n  justify-content: center;\n  &:hover {\n    ", "\n  }\n  svg {\n    width: ", "%;\n    height: ", ";\n  }\n  svg line {\n    stroke: ", ";\n  }\n\n  svg path {\n    fill: ", ";\n  }\n  cursor: pointer;\n  color: ", ";\n  ", ";\n"])), function (_a) {
    var width = _a.width;
    return width || "36px";
}, function (_a) {
    var height = _a.height;
...
var RoundButton = function (_a) {
    ...
    return (React.createElement(StyledRoundButton, { onClick: onClick, width: width, height: height, background: background, color: color, extra: extra }, children));
};
...
var ReviewInfo = styled.div(templateObject_2$1 || (templateObject_2$1 = tslib.__makeTemplateObject(["\n  scrollbar-width: none;\n"], ["\n  scrollbar-width: none;\n"])));
var ReviewTitle = styled.h3(templateObject_3$1 || (templateObject_3$1 = tslib.__makeTemplateObject(["\n  ", ";\n  text-transform: uppercase;\n  font-size: ", ";\n  text-align: center;\n"], ["\n  ", ";\n  text-transform: uppercase;\n  font-size: ", ";\n  text-align: center;\n"])), function (_a) {
    var theme = _a.theme;
...
var ReviewFrom = styled.h4(templateObject_4 || (templateObject_4 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n  text-align: center;\n  margin-bottom: ", ";\n"], ["\n  ", ";\n  font-size: ", ";\n  text-align: center;\n  margin-bottom: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.typography.nunito_l;
}, function (_a) {
    var theme = _a.theme;
...
var ReviewText = styled.p(templateObject_5 || (templateObject_5 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n  margin-bottom: ", ";\n  max-height: ", ";\n  overflow-y: ", ";\n  &::-webkit-scrollbar {\n    display: none;\n  }\n  scrollbar-width: none;\n  transition: max-height linear 0.4s;\n"], ["\n  ", ";\n  font-size: ", ";\n  margin-bottom: ", ";\n  max-height: ", ";\n  overflow-y: ", ";\n  &::-webkit-scrollbar {\n    display: none;\n  }\n  scrollbar-width: none;\n  transition: max-height linear 0.4s;\n"])), function (_a) {
    var theme = _a.theme;
...
var ReadMoreWrapper = styled.div(templateObject_6 || (templateObject_6 = tslib.__makeTemplateObject(["\n  ", ";\n  flex-direction: column;\n"], ["\n  ", ";\n  flex-direction: column;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.flexAlignCenter;
});
var ReadMoreTitle = styled.div(templateObject_7 || (templateObject_7 = tslib.__makeTemplateObject(["\n  ", ";\n  font-size: ", ";\n  text-transform: uppercase;\n  color: ", ";\n  margin-bottom: ", ";\n  cursor: pointer;\n  &:hover {\n    ", "\n  }\n"], ["\n  ", ";\n  font-size: ", ";\n  text-transform: uppercase;\n  color: ", ";\n  margin-bottom: ", ";\n  cursor: pointer;\n  &:hover {\n    ", "\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.typography.nunito_l;
}, function (_a) {
    var theme = _a.theme;
...
var Review = function (_a) {
    ...
    var _c = React.useState(false), isMoreOpen = _c[0], setIsMoreOpen = _c[1];
    var onReadMoreClick = function () {
        setIsMoreOpen(function (prev) { return !prev; });
    };
    return (React.createElement(ReviewWrapper, null,
        React.createElement(ReviewInfo, null,
            React.createElement(ReviewTitle, null, title),
            React.createElement(ReviewFrom, null,
                from,
                " ",
                author),
            React.createElement(ReviewText, { isOpen: isMoreOpen }, isMoreOpen ? text : handleReviewText(text, textLimit))),
        React.createElement(ReadMoreWrapper, null,
            React.createElement(ReadMoreTitle, { onClick: onReadMoreClick }, isMoreOpen ? hide : readMore),
            React.createElement(RoundButton, { onClick: onReadMoreClick, extra: readMoreRoundBtnExtraStyles }, isMoreOpen ? React.createElement(ArrowUpSvg, null) : React.createElement(ArrowDownSvg, null)))));
};

var DownSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "22", height: "32", viewBox: "0 0 22 32", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("path", { d: "M0.999999 19L11 31L21 19M1 0.999999L11 13L21 1", stroke: "#FEFEFE", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }))); };

var UpSvg = function (props) { return (React__namespace.createElement("svg", tslib.__assign({ width: "22", height: "32", viewBox: "0 0 22 32", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
    React__namespace.createElement("path", { d: "M21 13L11 1L0.999999 13M21 31L11 19L1 31", stroke: "#FEFEFE", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }))); };
...
var SliderWrapper = styled.div(templateObject_1 || (templateObject_1 = tslib.__makeTemplateObject(["\n  ", ";\n\n  svg {\n    height: ", ";\n    width: auto;\n    cursor: pointer;\n    transition: 0.2s linear;\n  }\n  svg:first-of-type {\n    margin-bottom: ", ";\n    transform: ", ";\n  }\n  svg:nth-of-type(2) {\n    transform: ", ";\n  }\n  svg:hover {\n    transform: ", ";\n  }\n  svg path {\n    stroke: ", ";\n  }\n"], ["\n  ", ";\n\n  svg {\n    height: ", ";\n    width: auto;\n    cursor: pointer;\n    transition: 0.2s linear;\n  }\n  svg:first-of-type {\n    margin-bottom: ", ";\n    transform: ", ";\n  }\n  svg:nth-of-type(2) {\n    transform: ", ";\n  }\n  svg:hover {\n    transform: ", ";\n  }\n  svg path {\n    stroke: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.flexAlignCenter;
}, function (_a) {
...
var SliderItemsWrapper = styled.div(templateObject_2 || (templateObject_2 = tslib.__makeTemplateObject(["\n  ", ";\n  flex-direction: ", ";\n  margin-right: 30px;\n  margin-left: ", ";\n  width: ", ";\n  height: ", ";\n  position: relative;\n  overflow: hidden;\n\n  @media (max-width: ", ") {\n    width: ", "\n"], ["\n  ", ";\n  flex-direction: ", ";\n  margin-right: 30px;\n  margin-left: ", ";\n  width: ", ";\n  height: ", ";\n  position: relative;\n  overflow: hidden;\n\n  @media (max-width: ", ") {\n    width: ", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.flexAlignCenter;
}, function (_a) {
    var direction = _a.direction;
...
var SliderControls = styled.div(templateObject_3 || (templateObject_3 = tslib.__makeTemplateObject(["\n  ", ";\n  flex-direction: column;\n"], ["\n  ", ";\n  flex-direction: column;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.flexAlignCenter;
});
...
var Slider = function (_a) {
    ...
    return (React.createElement(SliderWrapper, { onKeyDown: keyDownHandler, tabIndex: 0, onWheel: onMouseWheel, direction: direction },
        direction === SliderDirectionVariant.HORIZONTAL && (React.createElement(React.Fragment, null,
            React.createElement(UpSvg, { onClick: prevSlide }),
            React.createElement(SliderItemsWrapper, { direction: direction }, children),
            React.createElement(DownSvg, { onClick: nextSlide }))),
        direction === SliderDirectionVariant.VERTICAL && (React.createElement(React.Fragment, null,
            React.createElement(SliderItemsWrapper, { direction: direction }, children),
            React.createElement(SliderControls, null,
                React.createElement(UpSvg, { onClick: prevSlide }),
                React.createElement(DownSvg, { onClick: nextSlide }))))));
};
...
var SliderItems = function (_a) {
    ...
    return (React.createElement(React.Fragment, null, data === null || data === void 0 ? void 0 : data.map(function (item, idx) {
...
exports.BookSliderItem = BookSliderItem;
...
exports.MovieHallBadge = MovieHallBadge;
exports.MovieSliderItem = MovieSliderItem;
